...
public class AdminChatController {
	...
	@GetMapping
	public ResponseEntity<List<GetAdminChatRoomDetailResDto>> getAllChatRooms(
		@RequestParam(required = false) ChatStatus status) {
		List<GetAdminChatRoomDetailResDto> chatRooms = chatRoomService.findAllChatRoomsByFilter(status);
